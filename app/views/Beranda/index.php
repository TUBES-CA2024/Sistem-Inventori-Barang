...
<div class="content">
    <div class="content-beranda" style="overflow: hidden;">
        ...
        <div class="container"
            ...
            <div class="box"
                style="width: 100%; height: 90%; display: flex; justify-content:space-between; align-items: center; gap:20px;">
                <!-- Gambar Figure -->
