                                ...
                                <div class="sisi_bawah" style="display: flex; flex-direction: column; gap: 20px;">
                                    <div class="input-group" style="display: flex; gap: 20px; align-items: center; justify-content: center; margin-top: 30px;">
                                        ...
                                        <div class="jumlah_peminjaman" style="margin-left: 15%;">
                                            ...
                                            <input type="number" name="jumlah_peminjaman" class="jumlah_input" style="width: 80px; height: 35px; border-radius: 8px; background-color: rgba(202, 214, 255, 0.4); border: none; padding-left: 10px; box-shadow: 0px 5px 5px 0px rgba(0, 0, 0, 0.2);">
                                        </div>
                                        <div class="keterangan_peminjaman">
                                            <label for="keterangan_peminjaman">Keterangan</label><br>
                                            <input type="text" name="keterangan_peminjaman" class="keterangan_input" style="width: 250px; height: 35px; border-radius: 8px; background-color: rgba(202, 214, 255, 0.4); border: none; padding-left: 10px; box-shadow: 0px 5px 5px 0px rgba(0, 0, 0, 0.2);">
                                        </div>
                                        <div class="tombol-tambah-peminjaman">
                                            <button style="background-color: #0c1740; color: white; border-radius: 50%; height: 40px; width: 40px; display: flex; align-items: center; justify-content: center; box-shadow: 0px 5px 5px 0px rgba(0, 0, 0, 0.2); cursor: pointer; margin-top: 30px;">
