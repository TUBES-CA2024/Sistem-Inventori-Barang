    ...
    public function postDataBarang($data)
{
    ...
    $queryBarang = "INSERT INTO trx_barang (id_jenis_barang, id_merek_barang, id_kondis_barang, jumlah_barang, id_satuan, deskripsi_barang, tgl_pengadaan_barang, kode_barang, keterangan_label, id_lokasi_penyimpanan, deskripsi_detail_lokasi, id_status, status_peminjaman) VALUES (:id_jenis_barang, :id_merek_barang, :id_kondis_barang, :jumlah_barang, :id_satuan, :deskripsi_barang, :tgl_pengadaan_barang, :kode_barang, :keterangan_label, :id_lokasi_penyimpanan, :deskripsi_detail_lokasi, :id_status, :status_peminjaman)";
...
return $kodeBarang =  date('Y', strtotime($data['tgl_pengadaan_barang'])) . '/' . $romanMonth . '/' .  $kodeJenisBarang. '/' . $kodeMerekBarang. '/' . $data['barang-ke'] . '/' . $data['total_barang'];
...
public function hapusBarang($id_barang){
    ...
    public function ubahBarang($data)
    {
        ...
        id_jenis_barang = :id_jenis_barang, id_merek_barang = :id_merek_barang, id_kondis_barang = :id_kondis_barang, jumlah_barang = :jumlah_barang, id_satuan = :id_satuan, deskripsi_barang = :deskripsi_barang, tgl_pengadaan_barang = :tgl_pengadaan_barang, kode_barang = :kode_barang, keterangan_label = :keterangan_label, id_lokasi_penyimpanan = :id_lokasi_penyimpanan, deskripsi_detail_lokasi = :deskripsi_detail_lokasi, id_status = :id_status, status_peminjaman = :status_peminjaman WHERE id_barang = :id_barang";
